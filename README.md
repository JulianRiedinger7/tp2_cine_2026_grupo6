...
- PERFIL.HTML > Matías F. Ledesma (Arreglado con Ayudante. Realizacion posterior)
...
- CSS ASOCIADO A PERFIL > Matías F. Ledesma (Arreglado con Ayudante. Realizacion posterior)
...
- C. Documentacion (Docs)
  > Si la tarea consiste en generar o modificar documentacion:
      • Formato: docs/correccion-Iniciales
      • Ejemplo: docs/correcion-readme-ALL

#### 3. Proceso de Integración

Para mantener la integridad del código, queda estrictamente prohibido realizar un merge directo entre ramas locales. 1. Pull Request (PR): Toda integración de una rama personal hacia Dev, o de Dev hacia Main, debe realizarse mediante un Pull Request a través de la interfaz de GitHub. 2. Revisión: Los integrantes haran revisiones del codigo antes de que el compañero mergeé la rama. Esto asegura que se cumplan los estándares del proyecto antes de la unión final.
